package yousui115.unko.entity.ai;
...
/**
 * ■EntityAIAvoidEntity のパクリAI
 *
 */
public class EntityAIAvoidUnko extends EntityAIBase
{
    ...
    public EntityAIAvoidUnko(EntityLiving entityLiving, Predicate predicate, float p_i45890_3_, double p_i45890_4_, double p_i45890_6_)
    {
    ...
    {
        List list = this.theEntity.worldObj.func_175674_a(this.theEntity,
                                                          this.theEntity.getEntityBoundingBox().expand((double)this.field_179508_f,
                                                                                                       3.0D,
